...
Revises: 
Create Date: 2020-01-19 15:48:06.245923
...
def upgrade():
    ...
    sa.Column('results_string', sa.JSON(), nullable=True),
    ...
    sa.Column('type', sa.Enum('qualification', 'general_look', 'first_round', 're_dance', 'second_round', 'intermediate_round', 'eight_final', 'quarter_final', 'semi_final', 'final', name='roundtype'), nullable=True),
    sa.Column('min_marks', sa.Integer(), nullable=True),
    sa.Column('max_marks', sa.Integer(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.Column('heat_list_published', sa.Boolean(), nullable=True),
    sa.Column('competition_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['competition_id'], ['competition.competition_id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    sa.Column('final_placing', sa.Float(), nullable=True),
